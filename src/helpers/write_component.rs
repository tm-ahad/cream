use crate::{component::{Component, cream_dom_name}, helpers::javascript::{javascript_function::javascript_function, javascript_function_call::javascript_function_call, javascript_init_var::javascript_init_var}};
...
pub fn write_component(comp: Component) -> String {
    ...
    let script = format!("{}{}{}{}{}",
        javascript_init_var("onRender", "function(){}"),
